...
<section id="cta">
  <div class="container">
    ...
    <p class="cta-meta" data-i18n="cta.meta">⚡ ベータ価格 $9.99 · サブスクなし · Windows / Linux 対応</p>
  </div>
</section>
...
<script>
  const translations = {
    ja: {
      ...
      'cta.meta': '⚡ ベータ価格 $9.99 · サブスクなし · Windows / Linux 対応',
    ...
    en: {
      ...
      'cta.meta': '⚡ Beta price $9.99 · No subscription · Windows / Linux',
